...
let folder = '../inputs/d15/';
let testInput = fs.readFileSync(folder + 'test.txt').toString();
let inputData = fs.readFileSync(folder + 'input.txt').toString();

runSolution('test  ', () => part1(testInput, 10), 26);
runSolution('part_1', () => part1(inputData, 2_000_000), 4582667);

runSolution('test  ', () => part2(testInput, 20), 56000011);
runSolution('part_2', () => part2(inputData, 4000000), 10961118625406);
