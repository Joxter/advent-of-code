...
runSolution('test  ', () => part1(getTestData()), 10605);
runSolution('part_1', () => part1(getInputData()), 110888);

runSolution('test  ', () => part2(getTestData()), 2713310158);
runSolution('part_2', () => part2(getInputData()), 25590400731);
