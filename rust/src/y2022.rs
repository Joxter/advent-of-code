...
pub fn run_2022(days: &HashSet<i32>) {
    ...
    AoCDay::new(2022, 22, &days)
        .part1_ver("naive js copy", &(|inp| 0), &day22::naive_js_copy_part1) // todo add part1_real
        .part2_ver("naive js copy", &(|inp| 0), &day22::naive_js_copy_part2); // todo add part1_real
