...
function part2(inp) {
  ...
  for (let i = 0; i < hails.length; i++) {
    ...
    for (let j = 0; j < hails.length; j++) {
      ...
      let point1 = pointInTime(hail1, 1);
      let point2 = pointInTime(hail2, 3);

      let possibleLine1 = makeLineByDots(point2, point1);
      let possibleLine2 = makeLineByDots(point1, point2);

      possibleLine1.delta = possibleLine1.delta.map(it => it / 2);
      possibleLine2.delta = possibleLine2.delta.map(it => it / 2);
      ...
      if (isIntegers(possibleLine1.delta) && isIntegers(possibleLine2.delta)) {
        ...
        possible.push(moveStartTo(possibleLine1, -1));
        possible.push(moveStartTo(possibleLine1, -3));
        possible.push(moveStartTo(possibleLine2, -1));
        possible.push(moveStartTo(possibleLine2, -3));
      }
      ...
      // let inter = intersect3(possibleLine, hails[j])
      // console.log(inter);
      ...
      */
      ...
      // console.log(pointInTime(possibleLine, -1), pointInTime(possibleLine, -3));
